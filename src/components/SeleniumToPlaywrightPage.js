...
function SeleniumToPlaywrightPage() {
  ...
  async function handleConvert() {
    ...
    setIsLoading(true);
    try {
      const response = await fetch('http://98.70.54.50:8080/api/convert/seleniumToPlaywright', {
        method: 'POST',
  ...
  async function handleCompileSelenium() {
    ...
    setIsLoading(true);
    try {
      const response = await fetch('http://98.70.54.50:8080/api/convert/compileSelenium', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
 ...
 // Run Playwright code
  async function handleRunPlaywright() {
    ...
    setIsLoading(true);
    try {
      const response = await fetch('http://98.70.54.50:8080/api/convert/runPlaywrightProxy', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
